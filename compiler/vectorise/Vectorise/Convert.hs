...
fromVect (PiTy bndr res_ty) expr
  | Just arg_ty <- nonDependentType_maybe bndr
  = do
...
identityConv (PiTy {})       = noV $ text "identityConv: quantified type changes under vectorisation"
