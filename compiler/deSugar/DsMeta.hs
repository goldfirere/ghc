...
noSigIdKey        = mkPreludeMiscIdUnique 412
kindSigIdKey      = mkPreludeMiscIdUnique 413
tyVarSigIdKey     = mkPreludeMiscIdUnique 414

-- data InjectivityAnn = ...
injectivityAnnIdKey :: Unique
injectivityAnnIdKey = mkPreludeMiscIdUnique 415
